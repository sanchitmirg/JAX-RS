...
public class MessageService {
	...
	public MessageService(){
		...
		messages.put(1L, new Message(1L,"Hello world", "Sanchit"));
		messages.put(2L, new Message(2L,"Hello Jersey", "Sanchit"));
	}
	...
	public List<Message> getAllMessagesPaignated(int start, int size){
